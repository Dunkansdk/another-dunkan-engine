...
void game_entities(EntityManager& entity_manager) {
    ...
    entity_manager.add_component<PhysicsComponent>(entity1, PhysicsComponent{.x = 10.f, .y = 10.f, .z = 0.5f });
    ...
    entity_manager.add_component<CameraComponent>(entity2, CameraComponent{.zoom = 1.0f, .size = sf::Vector2f(1,1)});
